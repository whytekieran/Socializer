...
//User Mapper class for handling Users by Ciaran Whyte, the Mappable interface was written by Peter Nagy.
...
public class UserMapper implements Mappable<User> {
	...
	public boolean createEntry(User model) {
		try {
            ...
            Logger.getLogger(UserMapper.class.getName()).log(Level.SEVERE, "Could not create cassandra entry - message", e.getMessage());
        }
